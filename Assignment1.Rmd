...
From the IDA, it seems like the data itself is not distinctive enough to be able figure out the difference from first site.
...
## Research question 2:
As there was a lot of changes to the distribution of population before and after the pandemic, the impact of the change was investigated.
...
However, if we're talking about residential supplies, which corresponds to the 'General Supply' column of the data source.Than population matters less, because with residential usage, the amount of electricty consumption depends on the size of the housing, which is why I guess Central Coast has the most amount of electricty
(Note: Again, just to be cautious, it is considered that Ausgrid could've have a target customer base, which could explain part of this situation as well)

## References
@misc{jrara_17AD, title={plot - R barplot: wrapping long text labels?}, url={https://stackoverflow.com/questions/20241065/r-barplot-wrapping-long-text-labels}, journal={Stack Overflow}, author={jrara}, year={17AD}, month={Nov} }
